...
Millwright runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Clone and install Millwright from source
git clone https://github.com/tim-osterhus/millwright.git
cd millwright
npm ci
...
Create `~/.millwright/AGENTS.md` to help the agent understand the Termux environment:
