...
export function loadSkills(options: LoadSkillsOptions): LoadSkillsResult {
	...
	if (includeDefaults) {
		...
		addSkills(loadSkillsFromDirInternal(resolve(getWorkspaceStateDir(cwd), "skills"), "project", true));
	}

	const userSkillsDir = join(resolvedAgentDir, "skills");
	const projectSkillsDir = resolve(getWorkspaceStateDir(cwd), "skills");
