 ...
 * working indicator shown while Millwright is streaming a response.
 *
 * Usage:
 *   millwright --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore Millwright's default spinner
 */
...
function describeMode(mode: WorkingIndicatorMode): string {
	switch (mode) {
		...
		case "default":
			return "Millwright default spinner";
	}
}
