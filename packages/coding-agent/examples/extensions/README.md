...
Example extensions for Millwright.

## Usage

```bash
# From the repository root, load an extension with --extension
millwright --extension packages/coding-agent/examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.millwright/extensions/
```
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs the Millwright theme with macOS dark/light mode |
